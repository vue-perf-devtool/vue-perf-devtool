...
import { getInstanceRect } from './highlighter'
...
if (hook && !hook.perf && window.__VUE_DEVTOOLS_GLOBAL_HOOK__.Vue) {
  hook = window.__VUE_PERF_DEVTOOLS_GLOBAL_HOOK__
  hook.Vue = window.__VUE_DEVTOOLS_GLOBAL_HOOK__.Vue
}
...
function connect () {
  ...
  initPerfBackend(listMesuare, hook, bridge)
